...
import (
	...
	"github.com/Z3DRP/zedsync/internal/middleware"
	"github.com/Z3DRP/zedsync/internal/request"
	"github.com/Z3DRP/zedsync/internal/services"
	"github.com/golang-jwt/jwt/v4"
)

func NewServer(cfg config.ServerCfg, apis []services.API) *http.Server {
...
func registerRoutes(mux *http.ServeMux, apis []services.API) {
